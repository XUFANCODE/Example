...
public class Kruskal {
	/**
	 * 求图最小生成树的PRIM算法 基本思想：假设N=(V,{E})是连通网，TE是N上的最想生成树中的变得集合。算法从U={u0}(u0属于V)，
	...
	public static void PRIM(int[][] graph, int start, int n) {
		...
		for (int i = 0; i < n - 1; i++) {
			...
			mins[minV][1] = 0;
			System.out.println("最小生成树的第" + i + "条最小边=<" + (mins[minV][0] + 1)
					+ "," + (minV + 1) + ">，权重=" + minW);
	...
	public static void main(String[] args) {
		int[][] tree = { { -1, 6, 1, 5, -1, -1 }, { 6, -1, 5, -1, 3, -1 },
				{ 1, 5, -1, 5, 6, 4 }, { 5, -1, 5, -1, -1, 2 },
				{ -1, 3, 6, -1, -1, 6 }, { -1, -1, 4, 2, 6, -1 } };
		Kruskal.PRIM(tree, 0, 6);
		System.out.println("+++++++++++++++++++++++++++++++++");
